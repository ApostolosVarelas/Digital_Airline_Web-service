...
Όταν ο διαχειριστής επιθυμεί να ανανεώσει τις τιμές των εισιτηρίων, θα πρέπει να παέι στο URL __localhost:6000/flight_cost με μέθοδο PUT, αφού απλά θέλει να αλλάξει τις τιμές ήδη υπάρχοντων μεταβλητών. 
