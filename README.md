...
Όταν ο χρήστης επιθυμεί να κάνει ακύρωση κράτηση, θα πρέπει να παέι στο URL __localhost:6000/cancel_reservation__ με μέθοδο POST, αφού χρειάζεται να αλλάξουμε αρχεία στην βάση δεδομένων.
